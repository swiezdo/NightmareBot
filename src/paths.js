...
export const ROTATION_YOTEI_EN_PATH = path.join(ROOT, 'json', 'rotation_yotei_en.json');
export const ROTATION_YOTEI_RU_PATH = path.join(ROOT, 'json', 'rotation_yotei_ru.json');
